...
st.markdown("""
    ...
    /* SPECIFIC BOX FOR GRAPHS (The "Red Box" separation) */
    .graph-container {
...
uploaded = st.file_uploader("Upload processed_features.csv", type="csv")

if not uploaded:
    st.info("Please upload your CSV file to generate the intelligence report.")
    st.stop()
